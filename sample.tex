...
%% Provide the file name containing the sidebar contents as an optional parameter to \section.
%% You can always just use \marginpar{...} if you do
%% not need to align the top of the contents to any
%% \section title in the "main" bar.
\section[sample-p1sidebar]{Experience}
...
\clearpage
\section[page2sidebar]{Publications}
...
%% If the NEXT page doesn't start with a \section but you'd
